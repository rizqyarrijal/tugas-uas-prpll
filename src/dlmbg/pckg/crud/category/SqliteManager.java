...
public class SqliteManager {
	...
	public static final String[] FIELD_TABEL_PESANAN ={"_id", "banyak_pesanan", "alamat", "no_hp", "keterangan"};
	...
	private static class SqliteManagerHelper extends SQLiteOpenHelper {
		...
		private static final String TABEL_PESANAN =
				"CREATE TABLE IF NOT EXISTS TABEL_PESANAN (" +
				"_id integer primary key autoincrement," +
				"banyak_pesanan text NOT NULL," +
				"menu text NOT NULL," +
		...
		public void onCreate(SQLiteDatabase database) {
			...
			database.execSQL(TABEL_PESANAN);
		}
	...
	public Cursor bacaDataPesanan(String rowId) {
		
		return crudDatabase.query("tbl_pesanan", FIELD_TABEL_PESANAN, "id_kategori =" + rowId, null, null, null, null, null);
	}
	...
	public Cursor bacaDataTerseleksiPesanan(long rowId) throws SQLException {
		Cursor cursor = crudDatabase.query(true, "tbl_pesanan",FIELD_TABEL_PESANAN,"_id =" + rowId,null, null, null, null, null);
		cursor.moveToFirst();
		return cursor;
	}
	...
	public ContentValues ambilDataPesanan(String banyak_pesanan, String menu, String nama_pemesan, String alamat, String no_hp, String keterangan) {
		ContentValues values = new ContentValues();
		values.put("banyak_pesanan", banyak_pesanan);
		values.put("menu", menu);
		values.put("kelahiran", nama_pemesan);
		values.put("gambar", alamat);
