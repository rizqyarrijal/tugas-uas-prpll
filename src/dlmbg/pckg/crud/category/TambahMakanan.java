...
public class TambahMakanan extends Activity{
	...
	private EditText nama_makanan_et, harga_et, keterangan_et, gambar_et;
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(R.layout.simpan_makanan);

		nama_makanan_et = (EditText) findViewById(R.id.edit_nama_makanan);
		harga_et = (EditText) findViewById(R.id.edit_harga);
   ...
   @Override
	...
	private void pindahData() {
		if (id != null) {
			...
			nama_makanan_et.setText(cursor.getString(2));
			harga_et.setText(cursor.getString(3));
	...
	private void simpan() {
		String nama_penemu_save = nama_makanan_et.getText().toString();
		String kelahiran_save = harga_et.getText().toString();
