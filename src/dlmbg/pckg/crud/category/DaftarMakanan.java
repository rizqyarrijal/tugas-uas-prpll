...
public class DaftarMakanan extends ListActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	if (session.isLoggedIn() == true) 
		{
	        ...
	        inflater.inflate(R.menu.opt_menu_makanan, menu);
		}
        return true;
    }
	...
	public void tampilTempatTerseleksi(Long mRowId) {
		...
		Intent intent = new Intent(this, DetaiMakanan.class);
		intent.putExtra("id_makanan", cursor.getString(0));
		intent.putExtra("id_kategori", cursor.getString(1));
		intent.putExtra("nama_Makanan", cursor.getString(2));
