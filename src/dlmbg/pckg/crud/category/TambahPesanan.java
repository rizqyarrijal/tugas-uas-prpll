...
public class TambahPesanan extends Activity{
	...
	private EditText jml_pesanan_et, gambar_et, makanan_et, nama_pemesan_et, alamat_et, no_hp_et, keterangan_et;
	private Spinner kategori_sp;
	
	String jml_pesanan, makanan, nama_pemesan, harga, keterangan, gambar, alamat, no_hp;
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(R.layout.simpan_pesanan);

		jml_pesanan_et = (EditText) findViewById(R.id.edit_jml_pesanan);
		makanan_et = (EditText) findViewById(R.id.edit_nama_makanan);
		nama_pemesan_et = (EditText) findViewById(R.id.edit_nama_pemesan);
		alamat_et = (EditText) findViewById(R.id.edit_alamat);
		no_hp_et = (EditText) findViewById(R.id.edit_no_hp);
		...
		if (bundle == null) {
			...
			{
				makanan = extras.getString("nama makanan");
				jml_pesanan = extras.getString("jumlah_pesanan");
				nama_pemesan = extras.getString("nama pemesan");
				alamat = extras.getString("alamat");
				no_hp = extras.getString("no hp");
   ...
   @Override
	...
	private void pindahData() {
		if (id != null) {
			Cursor cursor = sqliteDB.bacaDataTerseleksiPesanan(id);
			makanan_et.setText(cursor.getString(2));
			jml_pesanan_et.setText(cursor.getString(3));
			nama_pemesan_et.setText(cursor.getString(4));
	...
	private void simpan() {
		String nama_penemu_save = makanan_et.getText().toString();
		String kelahiran_save = jml_pesanan_et.getText().toString();
